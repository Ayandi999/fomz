    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white/60 p-8 sm:p-12 rounded-3xl flex flex-col lg:flex-row items-center justify-between gap-12 border border-black/5">
            ...
            <div className="w-full lg:w-96 aspect-video bg-white/80 border border-black/5 rounded-2xl flex items-center justify-center p-6 relative overflow-hidden">
              <div className="w-full flex flex-col gap-3">
                ...
                <div className="grid grid-cols-2 gap-2 mt-1">
                  <div className="bg-white/60 border border-[#FF6B35]/30 p-2 rounded text-[10px] text-center text-[#111] font-semibold">Conversational</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/60 p-8 rounded-2xl flex flex-col gap-4 border border-black/5 hover:border-[#FF6B35]/20 hover:-translate-y-1 transition-all duration-300">
              <div className="w-10 h-10 rounded-xl bg-white/80 border border-black/5 flex items-center justify-center">
