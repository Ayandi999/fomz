...
export function ShellModeTheme(props: ThemeProps) {
  const {
  ...
  if (submitted) {
    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-[#0f172a] text-green-500 p-6 relative overflow-hidden select-none">
        ...
        <div className="w-full max-w-[720px] bg-[#1e293b] rounded-[24px] border border-slate-700/40 p-12 md:shadow-[0_8px_32px_rgba(0,0,0,0.4)] text-center relative z-10 flex flex-col items-center justify-center min-h-[360px]">
          ...
          <motion.h1 
            ...
            className="text-2xl md:text-3xl font-bold tracking-tight text-green-500 mb-2"
          >
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className={`w-full max-w-[720px] bg-[#1e293b] rounded-xl md:rounded-3xl p-4 md:p-6 pt-16 border border-slate-700/50 shadow-[0_0_50px_-12px_rgba(192,132,252,0.1)] border-slate-700/40 md:shadow-[0_8px_32px_rgba(0,0,0,0.4)] flex flex-col justify-between min-h-screen md:min-h-[480px] relative`}
      >
        {/* Header section */}
        ...
        <div className="flex-1 flex flex-col justify-start py-4" aria-live="polite" id="question-container">
          <AnimatePresence mode="wait">
            ...
            >
              {/* Question text block */}
              <div>
                <h2 className="font-mono text-sm md:text-base text-green-500 flex items-start break-words mb-0">
                  <span className="mr-3 select-none whitespace-nowrap"><span className="text-green-500 font-bold">formz</span><span className="text-white">:</span><span className="text-blue-400 font-bold">~/questions/{stepIndex + 1}</span><span className="text-white">/</span></span>
                  <span className="drop-shadow-[0_0_8px_rgba(34,197,94,0.6)]">{currentField.label || "Untitled Question"}</span>
                </h2>
                {currentField.placeholder && !["MULTIPLE_CHOICE","CHECKBOX","DROPDOWN","SLIDER","YES_NO","CONTACT_INFO","ADDRESS","RATING","LONG_TEXT","SHORT_TEXT"].includes(currentField.fieldType) && (
                  <p className="text-[#94a3b8] text-base leading-relaxed mb-0">{currentField.placeholder}</p>
                )}
              </div>

                            {/* Input Area Router */}
              <div className="font-mono text-sm md:text-base mb-4 flex items-start">
                <span className="mr-3 select-none whitespace-nowrap"><span className="text-green-500 font-bold">formz</span><span className="text-white">:</span><span className="text-blue-400 font-bold">~/questions/{stepIndex + 1}/answer</span><span className="text-white">$</span></span>
              </div>
              <div className="relative w-full">
                ...
                {currentField.fieldType === "SHORT_TEXT" && (
                  <div className="relative flex items-center w-full">
                    <input
                      ...
                      className="bg-transparent text-green-500 text-xl py-3 pr-8 w-full border-b border-slate-700 focus:outline-none placeholder-[#475569] transition-colors focus-within:shadow-[inset_0_-1px_0_0_#c084fc]"
                    />
                  ...
                  <div className="relative flex flex-col w-full">
                    <div className="relative flex items-end">
                      <textarea
                        ...
                        placeholder={currentField.placeholder || "Type your answer here..."}
                        rows={1}
                        className="bg-transparent text-green-500 text-lg py-3 pr-8 w-full border-b border-slate-700 focus:outline-none placeholder-[#475569] resize-none overflow-y-auto max-h-[300px]"
                        style={{ height: "auto" }}
                      />
                      {/* Bottom growing border */}
                      <div className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#c084fc] origin-center scale-x-0 transition-transform duration-300 pointer-events-none focus-within:scale-x-100" />
                ...
                {currentField.fieldType === "NUMBER" && (
                  <div className="relative flex items-center w-full">
                    <input
                      ...
                      className="bg-transparent text-green-500 text-xl py-3 pr-8 w-full border-b border-slate-700 focus:outline-none placeholder-[#475569]"
                    />
                    {isInputValid && (
                ...
                {currentField.fieldType === "EMAIL" && (
                  <div className="relative flex items-center w-full border-b border-slate-700 py-3">
                    ...
                    <input
                      ...
                      className="bg-transparent text-green-500 text-xl w-full focus:outline-none placeholder-[#475569]"
                    />
                    {isInputValid && (
                      <Check className="absolute right-2 w-4 h-4 text-[#34d399]" />
                    )}
                ...
                {currentField.fieldType === "DATE" && (
                  <input
                    ...
                    className="bg-[#0f172a] border border-slate-700 rounded-xl text-green-500 text-lg py-3 px-4 w-full focus:outline-none focus:border-[#c084fc] transition-colors"
                  />
                )}
                  ...
                  <div className="relative flex items-center w-full border-b border-slate-700 py-3">
                    ...
                    <div className="relative shrink-0 mr-2">
                      <button
                        ...
                        className="flex items-center gap-1.5 border border-slate-700 px-2 py-1 text-green-500 text-xs font-bold uppercase rounded-xl hover:border-[#c084fc] transition-colors"
                      >
                      ...
                      {phoneDropdownOpen && (
                        ...
                        >
                          <input
                            ...
                            className="bg-[#0f172a] border border-slate-700 px-2 py-1.5 text-xs text-green-500 focus:outline-none rounded-xl w-full"
                          />
                    ...
                    {["YES", "NO"].map(opt => (
                      ...
                      >
                        <span className={`w-5 h-5 flex items-center justify-center font-bold text-xs border rounded-xl ${
                          answers[currentField.id] === opt ? "bg-[#c084fc] text-green-500 border-[#c084fc]" : "border-slate-600 text-slate-400"
                        }`}>
                          {opt[0]}
                        </span>
                        {opt}
                      ...
                      return (
                        ...
                        >
                          <span className={`w-5 h-5 flex items-center justify-center shrink-0 border-2 rounded-xl transition-colors ${
                            ...
                            {checked && <Check className="w-3 h-3 text-green-500" />}
                          </span>
                          {opt}
                        </button>
                      );
                ...
                {currentField.fieldType === "DROPDOWN" && (
                  <div className="relative max-w-md mt-2">
                    ...
                    >
                      <span className={answers[currentField.id] ? "text-green-500" : "text-slate-400"}>
                      ...
                      <div key={child.id} className="flex flex-col gap-2">
                        ...
                        {child.fieldType === "EMAIL" ? (
                          <div className="flex items-center gap-2 border-b border-slate-700 focus-within:border-[#c084fc] transition-colors py-2">
                            ...
                            <input type="email" value={answers[child.id] ?? ""} onChange={e => setAnswer(child.id, e.target.value)} placeholder={child.placeholder || "email@example.com"} className="bg-transparent text-green-500 w-full focus:outline-none placeholder-[#475569] text-base" />
                          </div>
                        ) : child.fieldType === "PHONE" ? (
                          <div className="flex items-center gap-2 border-b border-slate-700 focus-within:border-[#c084fc] transition-colors py-2">
                            <PhoneIcon className="w-4 h-4 text-slate-400 shrink-0" />
                            <input type="tel" value={answers[child.id] ?? ""} onChange={e => setAnswer(child.id, e.target.value.replace(/[^0-9]/g, ""))} placeholder={child.placeholder || "(555) 000-0000"} className="bg-transparent text-green-500 w-full focus:outline-none placeholder-[#475569] text-base" />
                          </div>
                          ...
                          <div className="flex items-center gap-2 border-b border-slate-700 focus-within:border-[#c084fc] transition-colors py-2">
                            ...
                            <input type="text" value={answers[child.id] ?? ""} onChange={e => setAnswer(child.id, e.target.value)} placeholder={child.placeholder || "yourwebsite.com"} className="bg-transparent text-green-500 w-full focus:outline-none placeholder-[#475569] text-base" />
                          </div>
                        ) : (
                          <input type="text" value={answers[child.id] ?? ""} onChange={e => setAnswer(child.id, e.target.value)} placeholder={child.placeholder || ""} className="bg-transparent border-b border-slate-700 focus:border-[#c084fc] text-green-500 py-2 w-full focus:outline-none transition-colors placeholder-[#475569] text-base" />
                        )}
                      </div>
                    ))}
                  </div>
                      ...
                      {currentField.fieldType !== "AUDIO" ? (
                        <div className="flex flex-col gap-4">
                          <label className="border border-dashed border-slate-700 hover:border-[#c084fc] rounded-xl p-8 flex flex-col items-center justify-center gap-3 bg-[#0f172a]/40 transition-colors cursor-pointer text-center group">
                            ...
                            <span className="text-xs font-bold uppercase tracking-wider text-slate-200 group-hover:text-green-500 transition-colors">
                        ...
                        <div className="flex flex-col gap-4 border border-slate-700 p-5 bg-[#0f172a]/40 rounded-xl">
                          <div className="flex flex-col gap-2">
                            ...
                            <label className="border border-slate-700 hover:border-[#c084fc] p-3 flex items-center justify-center gap-2 cursor-pointer transition-colors bg-[#0f172a] rounded-xl">
                              ...
                              <span className="text-[10px] font-bold uppercase tracking-wider text-green-500">Choose File</span>
                            </label>
                          </div>
                              ...
                              <div className="flex gap-2">
                                {!isRecording ? (
                                  <button
                                    ...
                                    disabled={isUploading}
                                    className="w-full flex items-center justify-center gap-2 bg-[#c084fc] hover:bg-[#c084fc]/90 text-green-500 font-bold uppercase tracking-wider text-xs py-3 rounded-xl transition-all"
                                  >
                                  ...
                                  <button
                                    ...
                                    className="w-full flex items-center justify-center gap-2 bg-red-600 hover:bg-red-500 text-green-500 font-bold uppercase tracking-wider text-xs py-3 rounded-xl transition-all"
                                  >
                                    Stop Recording
                                  </button>
                                )}
                              ...
                              <div className="flex flex-col gap-3 border border-slate-700 p-3 bg-slate-800/50 rounded-xl">
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    disabled={isUploading}
                                    className="flex-1 flex items-center justify-center gap-1.5 bg-emerald-600 hover:bg-emerald-500 text-green-500 font-bold uppercase text-[10px] py-2 rounded-xl transition-colors"
                                  >
                                  ...
                                  <button
                                    ...
                                    disabled={isUploading}
                                    className="flex-1 flex items-center justify-center gap-1.5 border border-slate-700 text-slate-300 hover:text-green-500 font-bold uppercase text-[10px] py-2 rounded-xl transition-colors"
                                  >
                                    Reset
                                  </button>
                                </div>
                        ...
                        <div className="border border-slate-700 p-4 bg-[#0f172a]/60 rounded-xl flex flex-col gap-3">
                          ...
                          {currentField.fieldType === "FILE" && (
                            <div className="flex items-center justify-between gap-4 p-2 bg-[#0f172a] border border-slate-700 rounded-xl">
                              ...
                              <a href={currentUrl} target="_blank" rel="noopener noreferrer" className="text-[9px] font-bold uppercase border border-slate-600 px-2 py-1 hover:border-white transition-colors rounded text-green-500">Open</a>
                            </div>
                          )}
                        </div>
                      )}
        ...
        <div className="mt-8 pt-6 border-t border-slate-800 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="order-last md:order-first">
            <button
              ...
              className="w-full md:w-auto flex items-center justify-center gap-2 bg-[#c084fc] text-green-500 font-bold uppercase tracking-wider text-[14px] px-7 py-3.5 rounded-xl transition-all duration-200 hover:scale-[1.03] hover:brightness-110 hover:shadow-[0_4px_20px_rgba(255,107,53,0.3)] active:scale-[0.97] disabled:opacity-40 disabled:hover:scale-100 disabled:hover:brightness-100 disabled:hover:shadow-none disabled:cursor-not-allowed select-none"
            >
              {isSubmitting ? (
