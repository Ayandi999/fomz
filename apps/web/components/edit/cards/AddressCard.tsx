...
export function AddressCard({ question, mode, value, onChange, getQuestionChoices, getSliderBoundaries, childrenFields }: FieldCardProps) {
  return (
    ...
    <div className="flex flex-col gap-6 mt-2 w-full max-w-xl animate-fade-in">
      {childrenFields && childrenFields.length > 0 ? (
        ...
        <div className="text-neutral-500 text-sm">No address fields defined.</div>
      )}
    </div>
